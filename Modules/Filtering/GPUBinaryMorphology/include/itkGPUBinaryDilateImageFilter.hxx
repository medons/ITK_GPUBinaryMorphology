...
::GPUBinaryDilateImageFilter()
{
  ...
  if (isValid)
    {
      defines << "#define INTYPE " << validTypeName << "\n";
      defines << "#define OUTTYPE " << validTypeName << "\n";
      defines << "#define OPTYPE " << validTypeName << "\n";
      defines << "#define BOOL " << validTypeName << "\n";
    }
  else
    {
      std::ostringstream excpMsg;
      excpMsg << "GPUBinaryErodeImageFilter supports";
