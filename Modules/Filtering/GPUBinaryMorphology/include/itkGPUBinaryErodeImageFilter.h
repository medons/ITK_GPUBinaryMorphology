...
class __attribute__ ((visibility ("default"))) GPUBinaryErodeImageFilterKernel                  \
  {                                      \
    public:                              \
	__attribute__ ((visibility ("default")))  static const char* GetOpenCLSource(); \
    private:                             \
      GPUBinaryErodeImageFilterKernel();                          \
      virtual ~GPUBinaryErodeImageFilterKernel();                 \
      GPUBinaryErodeImageFilterKernel(const GPUBinaryErodeImageFilterKernel &);            \
      void operator=(const GPUBinaryErodeImageFilterKernel &);    \
  };
...
public:
  ...
  __attribute__ ((visibility ("default"))) static const char* GetOpenCLSource() \
    {                                 \
      return GPUBinaryErodeImageFilterKernel::GetOpenCLSource();  \
    }
