...
class __attribute__ ((visibility ("default"))) GPUBinaryDilateImageFilterKernel                  \
  {                                      \
    public:                              \
	__attribute__ ((visibility ("default")))  static const char* GetOpenCLSource(); \
    private:                             \
      GPUBinaryDilateImageFilterKernel();                          \
      virtual ~GPUBinaryDilateImageFilterKernel();                 \
      GPUBinaryDilateImageFilterKernel(const GPUBinaryDilateImageFilterKernel &);            \
      void operator=(const GPUBinaryDilateImageFilterKernel &);    \
  };
...
public:
  ...
  __attribute__ ((visibility ("default"))) static const char* GetOpenCLSource() \
    {                                 \
      return GPUBinaryDilateImageFilterKernel::GetOpenCLSource();  \
    }
